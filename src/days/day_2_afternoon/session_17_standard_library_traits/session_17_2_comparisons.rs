...
/// `eq` and provided method `ne`. The `==` and `!=` operators will call
/// these methods.
///
/// ```
///
...
/// ## `PartialOrd` and `Ord`
///
/// `PartialOrd` defines a partial ordering, with a `partial_cmp` method.
/// It is used to implement the `<`, `<=`, `>=`, and `>` operators.
///
/// ```
///
