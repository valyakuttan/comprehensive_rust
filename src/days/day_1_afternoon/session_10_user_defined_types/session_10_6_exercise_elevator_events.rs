/// 10.6 Exercise: Elevator Events
///
/// We will create a data structure to represent an event in an
/// elevator control system. It is up to you to define the types
/// and functions to construct various events. Use `#[derive(Debug)]`
