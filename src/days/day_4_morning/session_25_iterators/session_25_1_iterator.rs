...
/// # 25.1 `Iterator`
///
/// The `Iterator` trait supports iterating over values in a collection.
/// It requires a `next` method and provides lots of methods. Many
/// standard library types implement `Iterator`, and you can implement
/// it yourself, too:
///
